          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Basement Contractors was established with a commitment to work with highly skilled employees 
                with years of hands-on experience for the sole purpose of forming a small and highly skilled construction firm.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Over the years, we have undertaken many challenging projects and accumulated skills, 
                know-how and experience in design and building solutions, project management services and other related engineering works.
              </p>
